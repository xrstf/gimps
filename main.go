...
// This is based on https://github.com/kubermatic-labs/boilerplate,
// Apache License 2.0, (c) 2020 Kubermatic
...
func isGeneratedFile(filename string) (bool, error) {
	...
	// trim build constraints
	content = goBuildConstraintsRe.ReplaceAll(content, nil)

	// check the first line
	lines := bytes.SplitN(content, []byte{'\n'}, 2)

	return generatedRe.Match(bytes.ToLower(lines[0])), nil
}
